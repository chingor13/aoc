defmodule Aoc2016.Day3Test do
  ...
  test "basic triangle test" do
    assert false == Day3.valid_triangle?(5, 10, 25)
    assert false == Day3.valid_triangle?(5, 6, 23)
    assert false == Day3.valid_triangle?(3, 3, 6)
    assert true == Day3.valid_triangle?(5, 6, 7)
  end
  ...
  test "can count valid triagles" do
    assert 1 == Day3.num_valid_triangles([
      {5, 10, 25},
      {5, 6, 7},
      {5, 6, 12},
      {3, 3, 6}
